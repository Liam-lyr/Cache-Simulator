...
void InputUtilities::getCacheSize()
{
...
void InputUtilities::getCacheLineSize()
{
...
void InputUtilities::getMappingMethod()
{
    short temp = 0;
...
void InputUtilities::getLineCountEachSet()
{
...
void InputUtilities::getReplacePolicy()
{
    short temp;
...
void InputUtilities::getWritePolicy()
{
    short temp;
    puts("\nInput write policy:");
...
void InputUtilities::GetInput(int argc, char *argv[])
{
